    ...
    return function (widget) {
        ...
        $.widget('mage.orderReview', widget, {
            _submitUpdateOrder: function (url, resultId) {
                ...
                if (document.getElementById('shipping-method').value == 'redbox_shipping' && !window.localStorage.getItem('selected_locker')) {
                ...
                if (url && resultId && shippingMethod) {
                    ...
                    if (document.getElementById('shipping-method').value == 'redbox_shipping') {
